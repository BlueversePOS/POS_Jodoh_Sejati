CREATE OR ALTER PROC [dbo].[CMS_SO_GET_DTL_QUOTATION_BY_CONTRACT]
(
	@USERID VARCHAR(50),
	@INTERID VARCHAR(50),
	@PREFIX VARCHAR(50) = ''
...
BEGIN
	...
	BEGIN TRY
		...
		where A.CMS_CONTRACT_NO = @PREFIX
...
/*
	exec CMS_SO_GET_DTL_QUOTATION_BY_CONTRACT '','','CONTRACT/ID/00002'
