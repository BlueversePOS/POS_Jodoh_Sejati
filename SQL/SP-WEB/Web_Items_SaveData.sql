...
BEGIN
	BEGIN TRY
		...
		BEGIN
			...
			Track_Stock=@Track_Stock, InStock=@InStock, LowStock=@LowStock, Site_ID=@Site_ID, Tax_ID=@Tax_ID, Representation=@Representation, Item_Color=@Item_Color, 
		...
		BEGIN
			...
			Item_SKU, Item_Barcode, Composite_Item, Track_Stock, InStock, LowStock, Site_ID, Tax_ID, Representation, Item_Color, 
...
@Composite_Item=0,@Track_Stock=1,@InStock=50,@LowStock=10,@Tax_ID=N'1',@Representation=0,@Item_Color=N'bg-red',@Item_Shape=N'shape',
