...
namespace ProjectXYZAPI.Repository
{
    public class Repo
    {
        ...
        public DataTable GetCashManagement(string Batch_ID)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_GetCashManagement", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
        ...
        public DataTable GetListPayInPayOut(string Batch_ID)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_GetListPayInPayOut", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@Batch_ID", Batch_ID ?? "");
        ...
        public DataTable ReportsItemsGetDataTop5(ParamReport param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsItems_GetDataTop5", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsItemsGetDataChart(ParamReport param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsItems_GetDataChart", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsItemsGetDataList(ParamReport param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsItems_GetDataList", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsSummaryGetHeaderChart(ParamReportSummary param)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsSummary_GetHeaderChart", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsSummaryGetDataChart(ParamReportSummary param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsSummary_GetDataChart", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsSummaryGetDataList(ParamReportSummary param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsSummary_GetDataList", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
        ...
        public DataTable ReportsReceiptGetDataList(ParamReportReceipt param)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TRX_ReportsReceipts_GetDataList", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.Parameters.AddWithValue("@DateFrom", param.DateFrom);
                cmd.Parameters.AddWithValue("@DateTo", param.DateTo);
