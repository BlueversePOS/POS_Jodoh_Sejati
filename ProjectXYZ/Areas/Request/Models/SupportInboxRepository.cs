...
{
    public class SupportInboxRepository
    {
        ...
        public DataTable GetSupportInboxList(SupportInbox model)
        {
            ...
            try
            {
                ...
                string urlapi = urlpwoapi + "/api/RequestSupport/GetSupportInboxList";
        ...
        public DataTable SupportInboxUpdate(SupportInbox model)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/RequestSupport/SupportInboxUpdate";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
        ...
        public DataTable SupportInboxGetProgress(int DOCNM)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/RequestSupport/SupportInboxGetProgress";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
