$(document).ready(function () {
    ...
    $(".main-header").find(".title").html("Sales Discount");
    ...
    function GetData() {
        try {
            ...
            dtTable = $('#table_export').DataTable({
                ...
                ajax: {
                    type: "POST",
                    url: rootUrl + 'Reports/SalesDiscount/ReportsDiscountGetDataList',
                    "datatype": "json",
                    //async: false,
                    data: { 'model': model },
                    beforeSend: function () {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            var Discount_Amount = emptyStr(data) ? 0 : data;
                            return formatCurrency(Discount_Amount);
                        }
                    }
                ],
