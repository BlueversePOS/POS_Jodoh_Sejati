...
{
    public class SalesDiscountRepo
    {
        ...
        public DataTable ReportsDiscountGetDataList(SalesDiscount model)
        {
            ...
            try
            {
                ...
                string urlapi = urlpwoapi + "/api/Service/ReportsDiscountGetDataList";
