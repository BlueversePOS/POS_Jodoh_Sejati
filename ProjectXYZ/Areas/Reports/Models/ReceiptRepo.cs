...
namespace ProjectXYZ.Areas.Reports.Models
{
    public class ReceiptRepo
    {
        ...
        public DataTable ReportsReceiptGetDataList(Receipt model)
        {
            ...
            try
            {
                ...
                string urlapi = urlpwoapi + "/api/Service/ReportsReceiptGetDataList";
        ...
        public DataTable ReportsReceiptGetDetail(string DOCNUMBER)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/Service/ReportsReceiptGetDetail";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
