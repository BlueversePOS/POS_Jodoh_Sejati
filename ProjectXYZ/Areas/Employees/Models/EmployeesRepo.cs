...
namespace ProjectXYZ.Areas.Employees.Models
{
    public class EmployeesRepo
    {
        ...
        public DataTable SaveEmployee(Employeess model)
        {
            ...
            try
            {
                ...
                string urlapi = urlpwoapi + "/api/Service/SaveEmployee";
        ...
        public DataTable GetEmployee(string Employee_ID)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/Service/GetEmployee";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
