...
namespace ProjectXYZ.Areas.Setting.Models
{
    public class SettingsRepo
    {
        ...
        public DataTable SaveTaxes(Taxes model)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                var param = new
                {
                    ...
                    Tax_Option = model.Tax_Option
                };

                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/Service/SaveTaxes";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
        ...
        public DataTable GetNumberMaster(SettingsDocID model)
        {
            DataTable dt = new DataTable();
            string jsonapiresult = "";
            ...
            try
            {
                ...
                string inputJson = JsonConvert.SerializeObject(param);
                string urlapi = urlpwoapi + "/api/Service/GetNumberMaster";
                jsonapiresult = Task.Run(async () => await callAPI(urlapi, inputJson)).Result;
